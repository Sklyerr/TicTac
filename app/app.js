...
buttonNew.addEventListener("click", function() {
    ...
    resetGame();
});     // Кнопка новой игры В результатах

contactBtn.addEventListener("click", function() {
    document.getElementsByClassName("contact")[0].style = "opacity: 1; z-index: 1;"
})
closeBtn.addEventListener("click", function() {
    document.getElementsByClassName("contact")[0].style = "opacity: 0; z-index: -1;"
})
